...
const API_DOCS = {
  ...
  gameRules: {
    ...
    phaseDescriptions: {
      ...
      calculation: "Resolve combat via 8-step flow: Quick Strike → Power Comparison → Guardian → Healing → Determine Winner → Apply Net Damage → Care Package → VP/WP update",
    ...
    combatResolution: {
      ...
      steps: [
        ...
        { step: 2, name: "Quick Strike", description: "Cards with Quick Strike deal their trait value as direct HP damage to the opponent. This damage bypasses power comparison entirely. Commander first_strike abilities also apply here." },
        { step: 3, name: "Calculate Power", description: "Each card's final power is calculated: base power + buff modifiers - debuff modifiers (minimum 0). Totals for each side are summed." },
