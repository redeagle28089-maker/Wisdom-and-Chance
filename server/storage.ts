    ...
    const fireCommander: Commander = {
      ...
      abilities: [
        ...
        },
        {
          id: "ability-fire-2",
          name: "Inferno Blast",
          description: "Remove 5 advance counters: Deal damage equal to your total Fire unit power to the opponent.",
          phase: "combat",
          victoryCost: 5,
          withdrawalCost: 0,
        ...
        },
        {
          ...
          description: "Remove 5 defeat counters: Play an extra Fire unit from your hand during deployment.",
          phase: "deployment",
          victoryCost: 0,
          withdrawalCost: 5,
        ...
        },
        {
          ...
          description: "Remove 2 advance and 2 defeat counters: Shuffle Fire units from hand into deck, draw equal cards.",
          phase: "draw",
          victoryCost: 2,
          withdrawalCost: 2,
    ...
    const waterCommander: Commander = {
      ...
      abilities: [
        ...
        },
        {
          ...
          description: "Remove 5 advance counters: Negate all enemy effects, halve their strength if not Water units.",
          phase: "combat",
          victoryCost: 5,
          withdrawalCost: 0,
        ...
        },
        {
          ...
          description: "Remove 5 defeat counters: Play an extra Water unit from your hand during deployment.",
          phase: "deployment",
          victoryCost: 0,
          withdrawalCost: 5,
        ...
        },
        {
          id: "ability-water-5",
          name: "Current Flow",
          description: "Remove 2 advance and 2 defeat counters: Shuffle Water units from hand into deck, draw equal cards.",
          phase: "draw",
          victoryCost: 2,
          withdrawalCost: 2,
    ...
    const earthCommander: Commander = {
      ...
      abilities: [
        ...
        },
        {
          id: "ability-earth-2",
          name: "Earthquake",
          description: "Remove 5 advance counters: Target one non-Earth enemy unit and send it to the medical ward.",
          phase: "combat",
          victoryCost: 5,
          withdrawalCost: 0,
        ...
        },
        {
          ...
          description: "Remove 5 defeat counters: Play an extra Earth unit from your hand during deployment.",
          phase: "deployment",
          victoryCost: 0,
          withdrawalCost: 5,
        ...
        },
        {
          id: "ability-earth-5",
          name: "Tectonic Shift",
          description: "Remove 2 advance and 2 defeat counters: Shuffle Earth units from hand into deck, draw equal cards.",
          phase: "draw",
          victoryCost: 2,
          withdrawalCost: 2,
    ...
    const airCommander: Commander = {
      ...
      abilities: [
        ...
        },
        {
          id: "ability-air-2",
          name: "Cyclone Strike",
          description: "Remove 5 advance counters: All your Air units attack first, dealing damage before calculation.",
          phase: "combat",
          victoryCost: 5,
          withdrawalCost: 0,
        ...
        },
        {
          id: "ability-air-3",
          name: "Wind Barrier",
          description: "Remove 2 defeat counters: Give an Air unit you control +4 evasion this battle.",
          phase: "combat",
          victoryCost: 0,
          withdrawalCost: 2,
        ...
        },
        {
          ...
          description: "Remove 5 defeat counters: Play an extra Air unit from your hand during deployment.",
          phase: "deployment",
          victoryCost: 0,
          withdrawalCost: 5,
        ...
        },
        {
          id: "ability-air-5",
          name: "Whirlwind",
          description: "Remove 2 advance and 2 defeat counters: Shuffle Air units from hand into deck, draw equal cards.",
          phase: "draw",
          victoryCost: 2,
          withdrawalCost: 2,
    ...
    const natureCommander: Commander = {
      ...
      abilities: [
        ...
        },
        {
          id: "ability-nature-2",
          name: "Nature's Wrath",
          description: "Remove 5 advance counters: Return up to 3 units from your medical ward to your deck.",
          phase: "end",
          victoryCost: 5,
          withdrawalCost: 0,
        ...
        },
        {
          id: "ability-nature-4",
          name: "Forest's Gift",
          description: "Remove 5 defeat counters: Play an extra Nature unit from your hand during deployment.",
          phase: "deployment",
          victoryCost: 0,
          withdrawalCost: 5,
        ...
        },
        {
          id: "ability-nature-5",
          name: "Cycle of Life",
          description: "Remove 2 advance and 2 defeat counters: Shuffle Nature units from hand into deck, draw equal cards.",
          phase: "draw",
          victoryCost: 2,
          withdrawalCost: 2,
